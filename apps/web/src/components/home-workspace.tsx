...
export function HomeWorkspace({ workspaceId, role }: { workspaceId: string; role: HomeRole }) {
  ...
  return (
    <>
      ...
      <div className="homeDashboard ownerPulseDashboard">
        {role === "owner" ? (
          <section className="ownerMetricGrid" aria-label="運用収支の実データ">
            ...
            <OwnerMetric
              ...
              note={
                pulse?.missingCostCount ? `原価未配賦 ${pulse.missingCostCount}件` : "原価反映済み"
              }
                ...
                <>
                  ...
                  <div className="nextAction">
                    ...
                    <a
                      ...
                      href={requiresInventoryReview(current) ? "/inventory/stocktake" : "/workflow"}
                    >
